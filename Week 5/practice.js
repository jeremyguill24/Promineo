...
let student1 = new Student('Tom', 'Sawyer', '40230944107', 'A');
student1.introduce();
...
class NotificationSender {
    ...
    sendNotification(notification) {                        // this was taken from promotionssender class
...
class PromotionSender extends NotificationSender {
    ...
    //sendNotification(notification) {                      // was removed-just used to show how to cut down on code
    //  console.log('Sending: ' + notification);
...
class CollectionsSender extends NotificationSender {
    ...
    // sendNotification(notification) {                             // removed from here again to show how to cut on code and add all into 1 class
    //  console.log('Sending: ' + notification);
    //}
    //findUsersWithStatus(status) {
    //  let users = getUsers(status);
